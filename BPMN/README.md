...
Der Ordner enthält die Ergebnisse der Prozess- und Datenflussmodellierung:

- [`Diagramme`](Diagramme/): elf hochauflösende PNG-Prozessdiagramme – eine Gesamtprozesslandkarte und zehn im Abschlussbericht beschriebene Einzelprozesse – sowie eine grafische Übersicht der vornehmlich verwendeten BPMN-Elemente als PNG und SVG
- [`Modelle`](Modelle/): zwei vorhandene weiterbearbeitbare BPMN-2.0-Quelldateien
